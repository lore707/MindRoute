...
const data: AccountData = {
  ...
  portrait: {
    ...
    axes: [
      { axis: "exposure", value: 78, poleLeft: "familiarità", poleRight: "scoperta", pole: "scoperta", magnitude: "forte" },
      { axis: "matter", value: 86, poleLeft: "città", poleRight: "natura", pole: "natura", magnitude: "forte" },
      { axis: "social", value: 34, poleLeft: "solitudine", poleRight: "compagnia", pole: "solitudine", magnitude: "chiaro" },
      { axis: "comfort", value: 62, poleLeft: "comfort", poleRight: "avventura", pole: "avventura", magnitude: "lieve" },
      { axis: "structure", value: 50, poleLeft: "improvvisazione", poleRight: "programma", pole: "", magnitude: "neutro" },
    ],
  ...
  savedMoments: [
    { id: 41, createdAt: "2026-06-14", momentId: "m41", itineraryId: 12, momentSnapshot: { title: "Il silenzio lassù colpisce diverso.", image_url: P.lofoten, location_name: "Reine, Lofoten" } },
    { id: 33, createdAt: "2026-03-10", momentId: "m33", itineraryId: 10, momentSnapshot: { title: "Tramonto senza telefono. Presente al 100%.", image_url: P.procida, location_name: "Cinque Terre, Italia" } },
    { id: 27, createdAt: "2025-11-02", momentId: "m27", itineraryId: 9, momentSnapshot: { title: "Muri blu e mattine lente.", image_url: P.sahara, location_name: "Chefchaouen, Marocco" } },
    { id: 18, createdAt: "2025-05-21", momentId: "m18", itineraryId: 8, momentSnapshot: { title: "Natura selvaggia e oceano-terapia.", image_url: P.azores, location_name: "Madeira, Portogallo" } },
  ],
  continueItems: [],
  trips,
  stats: [],
