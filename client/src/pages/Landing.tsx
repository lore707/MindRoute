  ...
  return (
    <div className="bg-[var(--surface)] text-[var(--text-primary)] font-sans selection:bg-[#E94560]/20 overflow-x-hidden transition-colors duration-300">
      <section className="relative min-h-screen overflow-hidden px-6 pt-[118px] pb-14">
        ...
        <div className="hidden lg:block absolute left-[8%] top-[28%] w-[220px] h-[300px] rounded-[44px] border border-[rgba(29,25,53,0.08)] bg-[linear-gradient(180deg,rgba(255,255,255,0.76),rgba(255,255,255,0.18))] backdrop-blur-[6px] shadow-[0_30px_70px_rgba(29,25,53,0.06)]">
          <div className="absolute inset-5 rounded-[32px] border border-[rgba(233,69,96,0.08)]" />
          <div className="absolute left-8 top-9 text-[10px] font-semibold tracking-[3px] uppercase text-[rgba(29,25,53,0.36)]">State of mind</div>
          <div className="absolute left-8 top-[92px] right-8 h-[112px] rounded-[28px] bg-[radial-gradient(circle_at_top,rgba(233,69,96,0.18),rgba(233,69,96,0.02)_60%),linear-gradient(180deg,rgba(29,25,53,0.04),rgba(29,25,53,0))]" />
          <div className="absolute left-8 right-8 bottom-10 flex items-center justify-between text-[11px] text-[rgba(29,25,53,0.54)]">
            <span>Instinct</span>
            <span>Route</span>
          </div>
        </div>
        <div className="hidden lg:block absolute right-[7%] bottom-[18%] w-[250px] rounded-[32px] border border-[rgba(29,25,53,0.08)] bg-[rgba(255,255,255,0.72)] p-6 shadow-[0_24px_60px_rgba(29,25,53,0.06)] backdrop-blur-[10px]">
          <div className="text-[10px] font-semibold tracking-[3px] uppercase text-[#E94560] mb-4">Travel note</div>
          ...
          <div className="grid grid-cols-1 xl:grid-cols-[1.05fr_0.95fr] gap-8 items-stretch">
            ...
            >
              ...
              <div className="relative z-10 h-full flex flex-col justify-between">
                <div>
                  <div className="mb-7 inline-flex items-center gap-2 rounded-full border border-[rgba(255,255,255,0.14)] bg-[rgba(255,255,255,0.06)] px-4 py-2 text-[11px] font-semibold uppercase tracking-[3px] text-[rgba(255,255,255,0.78)]">
                    {lang === "it" ? "Cosa cambia davvero" : "What truly changes"}
                  </div>
                  <h3 className="font-serif text-[32px] md:text-[42px] leading-[1.04] tracking-[-1px] mb-4">
                ...
                <div className="mt-10 grid gap-4">
                  {[
                    ...
                    <div key={line} className="flex items-start gap-3 rounded-[22px] border border-[rgba(255,255,255,0.1)] bg-[rgba(255,255,255,0.04)] px-4 py-4">
                      ...
                      <p className="text-[14px] md:text-[15px] leading-[1.7] text-[rgba(255,255,255,0.82)]">{line}</p>
                    </div>
                  ))}
                </div>
              </div>
