  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center px-5 py-20" style={{ background: "#0a0710" }}>
      <div className="w-full max-w-md text-center">
        ...
        <p className="text-[10px] font-bold tracking-[3px] uppercase text-[#E94560] mb-3">{t("nf.eyebrow")}</p>
        <h1 className="font-serif text-2xl sm:text-3xl md:text-4xl text-white leading-tight tracking-tight mb-3">{t("nf.title")}</h1>
