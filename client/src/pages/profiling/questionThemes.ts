...
export function getMultipleThemes(selectedValues: string[]): QuestionTheme[] {
  ...
  'oceania': 'oceania',
    ...
    'asia': 'asia',
   // path b q3 IT
    'mangiare nei posti locali': 'food',
    'perdermi nei quartieri autentici': 'authentic',
    'vedere luoghi iconici': 'cultural',
    'stare immerso nella natura': 'nature',
