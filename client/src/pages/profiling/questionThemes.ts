...
export const questionThemes: Record<string, QuestionTheme> = {
  ...
  close: {
    ...
    overlayLight: "linear-gradient(180deg, rgba(255,255,255,0.72) 0%, rgba(255,255,255,0.62) 100%)",
  ...
  europe: {
    ...
    overlayLight: "linear-gradient(180deg, rgba(255,255,255,0.72) 0%, rgba(240,245,255,0.65) 100%)",
  ...
  asia: {
    ...
    overlayLight: "linear-gradient(180deg, rgba(255,255,255,0.72) 0%, rgba(255,245,240,0.65) 100%)",
  ...
  oceania: {
    ...
    overlayLight: "linear-gradient(180deg, rgba(255,255,255,0.72) 0%, rgba(235,248,255,0.65) 100%)",
  ...
  wild: {
    ...
    overlayLight: "linear-gradient(180deg, rgba(255,255,255,0.72) 0%, rgba(240,255,240,0.65) 100%)",
    overlayDark: "linear-gradient(180deg, rgba(0,20,10,0.48) 0%, rgba(0,0,0,0.36) 100%)",
  },
  quiet: {
    imageUrl: "https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=1200&q=80",
    overlayLight: "linear-gradient(180deg, rgba(255,255,255,0.74) 0%, rgba(245,248,255,0.68) 100%)",
  ...
  chaotic: {
    ...
    overlayLight: "linear-gradient(180deg, rgba(255,255,255,0.72) 0%, rgba(255,245,245,0.65) 100%)",
  ...
  intimate: {
    ...
    overlayLight: "linear-gradient(180deg, rgba(255,255,255,0.74) 0%, rgba(255,245,248,0.68) 100%)",
  ...
  regenerating: {
    ...
    overlayLight: "linear-gradient(180deg, rgba(255,255,255,0.74) 0%, rgba(240,255,250,0.68) 100%)",
  ...
  authentic: {
    ...
    overlayLight: "linear-gradient(180deg, rgba(255,255,255,0.72) 0%, rgba(255,248,240,0.65) 100%)",
  ...
  quietluxury: {
    ...
    overlayLight: "linear-gradient(180deg, rgba(255,255,255,0.74) 0%, rgba(255,252,245,0.68) 100%)",
  ...
  spiritual: {
    ...
    overlayLight: "linear-gradient(180deg, rgba(255,255,255,0.74) 0%, rgba(248,245,255,0.68) 100%)",
  ...
  cultural: {
    imageUrl: "https://images.unsplash.com/photo-1467269204594-9661b134dd2b?w=1200&q=80",
    overlayLight: "linear-gradient(180deg, rgba(255,255,255,0.72) 0%, rgba(245,245,255,0.65) 100%)",
  ...
  explorative: {
    ...
    overlayLight: "linear-gradient(180deg, rgba(255,255,255,0.72) 0%, rgba(240,255,252,0.65) 100%)",
  ...
  anywhere: {
    ...
    overlayLight: "linear-gradient(180deg, rgba(255,255,255,0.70) 0%, rgba(240,252,255,0.63) 100%)",
  ...
  city: {
    ...
    overlayLight: "linear-gradient(180deg, rgba(255,255,255,0.74) 0%, rgba(245,245,255,0.68) 100%)",
  ...
  default: {
    imageUrl: "https://images.unsplash.com/photo-1476514525535-07fb3b4ae5f1?w=1200&q=80",
    overlayLight: "linear-gradient(180deg, rgba(255,255,255,0.74) 0%, rgba(255,255,255,0.68) 100%)",
