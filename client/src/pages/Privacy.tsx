  ...
  return (
    <div className="min-h-screen" style={{ background: "#0f0a10" }}>
     ...
     <Link href="/" className="inline-flex items-center gap-2 text-white/50 hover:text-white text-sm mb-12 transition-colors">
        ...
        <p className="text-white/40 text-sm mb-12">{it ? "Ultimo aggiornamento: marzo 2026" : "Last updated: March 2026"}</p>

        <div className="space-y-10 text-white/70 leading-relaxed">

         <section>
            <h2 className="text-xl font-bold text-white mb-3">{it ? "1. Titolare del trattamento" : "1. Data Controller"}</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-white mb-3">{it ? "2. Dati raccolti" : "2. Data Collected"}</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-white mb-3">{it ? "3. Finalità del trattamento" : "3. Purpose of Processing"}</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-white mb-3">{it ? "4. Base giuridica" : "4. Legal Basis"}</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-white mb-3">{it ? "5. Cookie" : "5. Cookies"}</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-white mb-3">{it ? "6. Conservazione dei dati" : "6. Data Retention"}</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-white mb-3">{it ? "7. Condivisione dei dati" : "7. Data Sharing"}</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-white mb-3">{it ? "8. I tuoi diritti" : "8. Your Rights"}</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-white mb-3">{it ? "9. Link di affiliazione" : "9. Affiliate Links"}</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-white mb-3">{it ? "10. Modifiche alla privacy policy" : "10. Changes to this Privacy Policy"}</h2>
