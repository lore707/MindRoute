...
export const portraitDict: Record<string, { en: string; it: string }> = {
  ...
  // ── Ritratto 2026-08-20 (dal prototipo desktop/mobile) ──────────────────
  "pt2.kick":        { en: "Your portrait",  it: "Il tuo ritratto" },
  "pt2.title":       { en: "This is who you are,", it: "Ecco chi sei," },
  "pt2.titleEm":     { en: "today.",         it: "oggi." },
  "pt2.confidence":  { en: "Confidence",     it: "Confidenza" },
  "pt2.tripsSeen":   { en: "Trips observed", it: "Viaggi osservati" },
  "pt2.continents":  { en: "Continents",     it: "Continenti" },
  "pt2.lastUpdate":  { en: "Last updated: {date}", it: "Ultimo aggiornamento: {date}" },
  "pt2.share":       { en: "Share", it: "Condividi" },
  "pt2.refresh":     { en: "Update with new trips", it: "Aggiorna con i nuovi viaggi" },

  "pt2.arc.yesterday": { en: "Yesterday",  it: "Ieri" },
  "pt2.arc.today":     { en: "Today",      it: "Oggi" },
  "pt2.arc.toward":    { en: "Where you're heading", it: "Verso dove stai andando" },
  "pt2.arc.was":       { en: "You looked for {pole}.", it: "Cercavi {pole}." },
  "pt2.arc.now":       { en: "{pole}, without stopping.", it: "{pole}, senza fermarti." },
  "pt2.arc.going":     { en: "You're becoming more {pole}.", it: "Stai diventando più {pole}." },

  "pt2.s1.k":   { en: "How you travel",  it: "Il tuo modo di viaggiare" },
  "pt2.s1.sub": { en: "The principles that stay stable over time.", it: "I principi che restano stabili nel tempo." },
  "pt2.s2.k":   { en: "The tensions that move you", it: "Le tensioni che ti muovono" },
  "pt2.s2.sub": { en: "We don't try to resolve them — they are what makes you specific.", it: "Non cerchiamo di risolverle: sono ciò che ti rende specifico." },
  "pt2.s3.k":   { en: "How you got here", it: "Come ci sei arrivato" },
  "pt2.s3.sub": { en: "A path of change, not a straight line.", it: "Un percorso di cambiamento, non una linea retta." },
  "pt2.s4.k":   { en: "What we don't know yet", it: "Quello che non sappiamo ancora" },
  "pt2.s4.sub": { en: "Some parts are still forming.", it: "Alcune parti sono ancora in evoluzione." },

  "pt2.why":    { en: "Why?",   it: "Perché?" },
  "pt2.but":    { en: "but",    it: "ma" },
  "pt2.conf.high": { en: "High confidence",   it: "Alta confidenza" },
  "pt2.conf.mid":  { en: "Medium confidence", it: "Media confidenza" },
  "pt2.conf.low":  { en: "Low confidence",    it: "Bassa confidenza" },

  "pt2.ten.said":     { en: "You say you look for {pole}", it: "Dici di cercare {pole}" },
  "pt2.ten.chose":    { en: "you choose {pole}.",          it: "scegli {pole}." },
  "pt2.ten.revealedBody": { en: "What you declare and what you pick do not line up on {theme} — and your real taste lives in that gap.", it: "Quello che dichiari e quello che scegli non coincidono su {theme} — ed è in quello scarto che vive il tuo gusto vero." },
  "pt2.ten.want":     { en: "You want {pole}",  it: "Vuoi {pole}" },
  "pt2.ten.andAlso":  { en: "you also want {pole}.", it: "vuoi anche {pole}." },
  "pt2.ten.axisBody": { en: "Across {n} readings you never settled on one side. It is not missing data — it is a real oscillation.", it: "In {n} letture non ti sei mai fermato da una parte. Non è un dato mancante: è un'oscillazione vera." },

  "pt2.became":     { en: "You became {pole}.",     it: "Sei diventato {pole}." },
  "pt2.deeper":     { en: "Deeper into {pole}.",     it: "Sempre più {pole}." },
  "pt2.fromTo":     { en: "From {from} to {to}.",    it: "Da {from} a {to}." },
  "pt2.afterTrip":  { en: "Seen around {dest}",      it: "Visto attorno a {dest}" },
  "pt2.step":       { en: "Step {n}",                it: "Tappa {n}" },
  "pt2.stepDetail": { en: "The change showed up in the readings closest to {dest} ({when}).", it: "Il cambiamento si è visto nelle letture più vicine a {dest} ({when})." },

  "pt2.clear":   { en: "Very clear",       it: "Molto chiaro" },
  "pt2.fair":    { en: "Fairly clear",     it: "Abbastanza chiaro" },
  "pt2.none":    { en: "Nothing here yet.", it: "Ancora niente qui." },
  "pt2.helpH":   { en: "Still to understand", it: "Ancora da capire" },
  "pt2.helpP":   { en: "Every answer sharpens your profile and makes the suggestions more precise.", it: "Ogni risposta affina il tuo profilo e rende i suggerimenti più precisi." },
  "pt2.helpCta": { en: "Talk to the Companion", it: "Parla con il Companion" },
  "pt2.alive":   { en: "Your portrait is alive: it grows with you, updates itself, and can be corrected whenever you want.", it: "Il Ritratto è vivo: cresce con te, si aggiorna e può essere corretto quando vuoi." },

  "pt2.rail.k":    { en: "Interactions and depth", it: "Interazioni e approfondimenti" },
  "pt2.rail.p":    { en: "Tap “Why?” on any reading and see the reasoning behind it.", it: "Clicca su “Perché?” su qualsiasi lettura e scopri il ragionamento dietro." },
  "pt2.rail.idle": { en: "Nothing open yet.",      it: "Ancora niente di aperto." },
  "pt2.panel.principle": { en: "Principle", it: "Principio" },
  "pt2.observed":  { en: "What we observed",  it: "Cosa abbiamo osservato" },
  "pt2.obsTrips":  { en: "{n} of your trips back this reading.", it: "{n} dei tuoi viaggi sostengono questa lettura." },
  "pt2.obsSnaps":  { en: "It shows up across {n} readings of your profile, not one.", it: "Compare in {n} letture del tuo profilo, non in una sola." },
  "pt2.seeEvidence": { en: "See the evidence", it: "Vedi le evidenze" },
  "pt2.recognise":   { en: "Do you recognise yourself in this?", it: "Ti riconosci in questa lettura?" },
  "pt2.recogniseK":  { en: "Do you recognise yourself?", it: "Ti riconosci?" },
  "pt2.recogniseQ":  { en: "Does this reading represent you?", it: "Questa lettura ti rappresenta?" },
  "pt2.evidenceN":   { en: "Evidence ({n})", it: "Evidenze ({n})" },
  "pt2.noEvidence":  { en: "This reading comes from what you chose in the quiz, not from a trip — so there is nothing to show here.", it: "Questa lettura nasce dai chip che hai scelto nel quiz, non da un viaggio: qui non c'è nulla da mostrare." },
  "pt2.tagTrip":     { en: "Trip", it: "Viaggio" },
  "pt2.v.yes":     { en: "Yes, that is very much me", it: "Sì, mi rappresenta molto" },
  "pt2.v.partly":  { en: "Only in part",             it: "Solo in parte" },
  "pt2.v.no":      { en: "Not any more",             it: "Non mi rappresenta più" },
  "pt2.helpMe":   { en: "Help me understand you better", it: "Aiutami a capirti meglio" },
  "pt2.whatNot":  { en: "What does not represent you?", it: "Cosa non ti rappresenta?" },
  "pt2.whatNotP": { en: "Pick what is no longer true for you.", it: "Scegli cosa non è più vero per te." },
  "pt2.r.pace":      { en: "Pace too slow",      it: "Ritmo troppo lento" },
  "pt2.r.changed":   { en: "My preferences changed", it: "Preferenze cambiate" },
  "pt2.r.different": { en: "I travel differently now", it: "Viaggi diversi" },
  "pt2.r.other":     { en: "Something else",     it: "Altro" },
  "pt2.moreQ":     { en: "Want to tell us more?",    it: "Vuoi dirci qualcosa in più?" },
  "pt2.notePh":    { en: "Write here (optional)…",   it: "Scrivi qui (facoltativo)…" },
  "pt2.send":      { en: "Send feedback",            it: "Invia feedback" },
  "pt2.sendFine":  { en: "Your feedback updates your profile.", it: "Il tuo feedback aggiornerà il tuo profilo." },
  "pt2.sendErr":   { en: "It did not go through. Nothing was saved.", it: "Non è passato. Non è stato salvato nulla." },
  "pt2.thanks":    { en: "Noted. The next reading takes it into account.", it: "Registrato. La prossima lettura ne terrà conto." },

  // evidenze — perché QUEL viaggio conta per QUELLA lettura
  "pt.ev.continent": { en: "A trip in {continent}.", it: "Un viaggio in {continent}." },
  "pt.ev.month":     { en: "Month {month}", it: "Mese {month}" },
  "pt.ev.days":      { en: "{n} days", it: "{n} giorni" },
  "pt.ev.notTaken":  { en: "Planned, not taken yet.", it: "Progettato, non ancora fatto." },
  "pt.ev.taken":     { en: "You said you actually went.", it: "Hai detto che ci sei andato davvero." },
  "pt.ev.context":   { en: "Context for this reading.", it: "Contesto per questa lettura." },
