...
export const itineraryFlowDict: Record<string, { en: string; it: string }> = {
  ...
  "if.ov.placeKick": { en: "Know the place", it: "Conosci il luogo" },
  "if.ov.placeHistory": { en: "History and culture", it: "Storia e cultura" },
  "if.ov.placeTradeoff": { en: "Worth knowing", it: "Da sapere" },
  "if.ov.themeKick": { en: "Why this journey takes this shape", it: "Perché questo viaggio prende questa forma" },
