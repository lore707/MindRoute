...
export const accountCinDict: Record<string, { en: string; it: string }> = {
  ...
  // AccountPortrait — strings hard-coded in component not yet in account.ts
  "acin.portrait.neutralAxis":   { en: "in balance", it: "in equilibrio" },
  "acin.portrait.ownWords":      { en: "In your own words", it: "Con parole tue" },
};
